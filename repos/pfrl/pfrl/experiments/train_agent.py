...
from repos.pfrl.pfrl.utils.ask_yes_no import ask_yes_no
...
def train_agent_with_evaluation(
    ...
    Args:
        agent: A repos.pfrl.pfrl.agent.Agent
        ...
        step_hooks (Sequence): Sequence of callable objects that accepts
            ...
            See repos.pfrl.pfrl.experiments.hooks.
        evaluation_hooks (Sequence): Sequence of
            repos.pfrl.pfrl.experiments.evaluation_hooks.EvaluationHook objects. They are
