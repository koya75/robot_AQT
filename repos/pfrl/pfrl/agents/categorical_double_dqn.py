...
from repos.pfrl.pfrl.agents import categorical_dqn
from repos.pfrl.pfrl.agents.categorical_dqn import _apply_categorical_projection
...
class CategoricalDoubleDQN(categorical_dqn.CategoricalDQN):
    ...
    def _compute_target_values(self, exp_batch):
        ...
        with pf.utils.evaluating(self.target_model), pf.utils.evaluating(
            self.model
        ):
            if self.recurrent:
